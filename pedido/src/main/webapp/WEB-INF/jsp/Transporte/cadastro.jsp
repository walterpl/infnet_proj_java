...
<body>
	<div class="container mt-3">
		<h2>Cadastro de Empresas para locação.</h2>
		<form action="/Transporte/incluir" method="post">
			<div class="mb-3 mt-3">
			...
			<div class="mb-3">
				<label for="pwd">Seguro disponível:</label> <input type="text"
					class="form-control" id="pwd" placeholder="Informe a idade"
					name="age">
			</div>
			<div class="mb-3">
				<label for="pwd">Tipo de Veículo:</label> <input type="text"
